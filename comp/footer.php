 ...
 <footer class="flex justify-center flex-col sm:p-0 sm:w-full">
        <div class="footer-first-part flex flex-col sm:flex-row justify-around py-10">
            <section class="text-white flex items-baseline flex-col">
                ...
                <section class="flex social mx-auto sm:mx-0 justify-between w-24 mt-1">
                    <svg width="20" height="20" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M283.334 33.3359H116.667C70.6436 33.3359 33.334 70.6455 33.334 116.669V283.336C33.334 329.36 70.6436 366.669 116.667 366.669H283.334C329.358 366.669 366.667 329.36 366.667 283.336V116.669C366.667 70.6455 329.358 33.3359 283.334 33.3359Z" stroke="#8BD8BD" stroke-width="40" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M266.663 189.505C268.72 203.376 266.351 217.542 259.892 229.989C253.434 242.435 243.216 252.529 230.69 258.833C218.165 265.137 203.971 267.332 190.126 265.104C176.282 262.876 163.492 256.34 153.577 246.424C143.662 236.509 137.125 223.72 134.898 209.875C132.67 196.031 134.864 181.837 141.169 169.311C147.473 156.786 157.566 146.567 170.013 140.109C182.459 133.651 196.626 131.281 210.496 133.338C224.645 135.436 237.744 142.029 247.858 152.143C257.972 162.258 264.565 175.356 266.663 189.505Z" stroke="#8BD8BD" stroke-width="40" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M291.666 108.336H291.833" stroke="#8BD8BD" stroke-width="40" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                ...
                <section class="flex flex-col mt-5 ml-3 sm:ml-0 sm:mt-0">
                    ...
                    <h3 class="mt-5 leading-none flex items-end ">
                        ...
                        <a class="text-sm leading-none pl-3">
                            +91 9090103010
                        </a>
                    </h3>
            ...
            <section class="text-white flex flex-col ml-3 sm:ml-0 mt-3 sm:mt-0">
                ...
                <h3 class="py-2"> <b> Useful links </b> </h3>
