...
<body>
    ...
    <div class="flex justify-center about mt-16 py-2">
    ...
    <div class="flex flex-col justify-center mx-auto collection pb-16">
        <h2 class="text-4xl collection-title uppercase text-center mt-16"> Our COLLECTION</h2>
    ...
    <div class="flex justify-around w-full flex-col sm:flex-row flex-wrap-reverse enquiry bg-black text-white py-6">
    ...
    <footer class="flex justify-center flex-col  sm:p-0 sm:w-full">
        ...
        <img src="images/Maxcera-logo.png" class="logo mx-auto sm:mx-0" alt="logo" />
            ...
            <section class="flex flex-col mt-3 sm:mt-0">
                ...
                <h3 class="mt-4 leading-none flex items-end ">
